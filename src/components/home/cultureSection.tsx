  ...
  return(
    <>
      <section className="bg-gray-200">
        <div className="grid grid-cols-1 md:grid-cols-2 p-12 space-x-13 lg:space-x-0">
          {/* IMG */}
          ...
          <div className="py-10">
            ...
            <div className="flex flex-wrap gap-y-4 pt-8">
              <span>
                En INWARD, colaboramos con los líderes de negocio para convertir la visión estratégica en acciones concretas que crean valor. 
